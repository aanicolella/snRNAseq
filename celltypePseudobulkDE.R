...
filepath <- "parentDir/cellType_totalExpression_date.csv"
...
write.csv(resMergeHT, "cellType_HTWT-DESeq2_allgenes.csv")
...
dim(resMergeHT)
resMergeHT <- resMergeHT[order(resMergeHT$pvalue),]
write.csv(resMergeHT, "cellType_HTWT-DESeq2_LFCshrink.csv")
...
write.csv(resMergeKO, "cellType_KOWT-DESeq2_allgenes.csv")
...
dim(resMergeKO)
resMergeKO <- resMergeKO[order(resMergeKO$pvalue),]
write.csv(resMergeKO, "cellType_KOWT-DESeq2_LFCshrink.csv")
...
write.csv(resMergeKOHT, "cellType_KOHTWT-DESeq2_allgenes.csv")
...
dim(resMergeKOHT)
resMergeKOHT <- resMergeKOHT[order(resMergeKOHT$pvalue),]
write.csv(resMergeKOHT, "cellType_KOHT-DESeq2_LFCshrink.csv")